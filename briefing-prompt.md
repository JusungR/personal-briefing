...
1. **중요도·균형 (관심분야 우선)**: 후보에서 **경제·주식시장·AI/기술**을 균형 있게
   ...
   - **🇺🇸/🇪🇺 분류는 후보의 `region` 태그가 아니라 기사 주제국(主題國) 기준이다.**
     `region`은 *매체 출처지*일 뿐이라 주제와 다를 수 있다(예: FT(EU 태그)의 미국
     제조업 기사 → 🇺🇸 미국으로 분류). 주제국이 미·유럽이 아니면(아시아·중동 등)
     가장 관련이 큰 시장으로 배치하거나 기타로 처리한다.
